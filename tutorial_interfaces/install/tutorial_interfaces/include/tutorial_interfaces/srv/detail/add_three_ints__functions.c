  ...
  tutorial_interfaces__srv__AddThreeInts_Request__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    ...
    tutorial_interfaces__srv__AddThreeInts_Request * data =
      (tutorial_interfaces__srv__AddThreeInts_Request *)realloc(output->data, allocation_size);
    if (!data) {
      return false;
    }
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!tutorial_interfaces__srv__AddThreeInts_Request__init(&data[i])) {
        /* free currently allocated and return false */
        for (; i-- > output->capacity; ) {
          tutorial_interfaces__srv__AddThreeInts_Request__fini(&data[i]);
        }
        free(data);
        return false;
      }
  ...
  tutorial_interfaces__srv__AddThreeInts_Response__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    ...
    tutorial_interfaces__srv__AddThreeInts_Response * data =
      (tutorial_interfaces__srv__AddThreeInts_Response *)realloc(output->data, allocation_size);
    if (!data) {
      return false;
    }
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!tutorial_interfaces__srv__AddThreeInts_Response__init(&data[i])) {
        /* free currently allocated and return false */
        for (; i-- > output->capacity; ) {
          tutorial_interfaces__srv__AddThreeInts_Response__fini(&data[i]);
        }
        free(data);
        return false;
      }
